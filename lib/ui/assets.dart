...
class Assets {
  ...
  static late final Sprite scorebar;
  static late final Sprite recordbar;
  ...
  static Future<void> load() async {
    final atlas = await TextureAtlas().load('SpaceRoad.atlas');
    // button = atlas.findSpriteByName('button')!;
    buttonPause = atlas.findSpriteByName('pausebtn')!;
    // buttonBack = atlas.findSpriteByName('buttonBack')!;
    background = atlas.findSpriteByName('bg')!;
    button = atlas.findSpriteByName('button')!;
    scorebar = atlas.findSpriteByName('scorebar')!;
    recordbar = atlas.findSpriteByName('recordbar')!;

    // atlas.findSpriteByName('background')!;
